...
import {
  checkLocalCustomizationSymbols,
  facadeOnlyFiles,
...
import { runPublicApiChecks } from './rules/source/public-api-check.mjs';
...
export function runCoreBoundaryCheck() {
  ...
  runPublicApiChecks(publicApiAllowlistRules, {
    failures,
    repoPathToFsPath,
    readText,
    publicApiContractSliceSet,
  });
