...
export const SCENE_TAB_REGISTRY: SceneTabDef[] = [
  ...
  // ── LVPA 修仙场景 ──
  {
    id: 'lvpa-sect' as SceneTabId,
    label: '宗门',
    labelKey: 'lvpa.scenes.sect',
    Icon: Building2,
    pinned: false,
    singleton: true,
    defaultOpen: false,
  ...
  {
    id: 'lvpa-workshop' as SceneTabId,
    label: '工坊',
    labelKey: 'lvpa.scenes.workshop',
    Icon: Wrench,
    pinned: false,
    singleton: true,
    defaultOpen: false,
  ...
  {
    id: 'lvpa-market' as SceneTabId,
    label: '坊市',
    labelKey: 'lvpa.scenes.market',
    Icon: ShoppingBag,
    pinned: false,
    singleton: true,
    defaultOpen: false,
  ...
  {
    id: 'lvpa-cave' as SceneTabId,
    label: '洞府',
    labelKey: 'lvpa.scenes.cave',
    Icon: Home,
    pinned: false,
    singleton: true,
    defaultOpen: false,
  ...
  {
    id: 'lvpa-library' as SceneTabId,
    label: '藏经阁',
    labelKey: 'lvpa.scenes.library',
    Icon: BookOpen,
    pinned: false,
    singleton: true,
    defaultOpen: false,
  ...
  {
    id: 'lvpa-gate' as SceneTabId,
    label: '接引台',
    labelKey: 'lvpa.scenes.gate',
    Icon: DoorOpen,
    pinned: false,
    singleton: true,
    defaultOpen: false,
