...
export const SETTINGS_TAB_SEARCH_CONTENT: Record<ConfigTab, readonly SettingsTabSearchPhrase[]> = {
  ...
  'ai-thresholds': [
    ...
    { ns: 'settings/thresholds', key: 'fields.compression.trigger_percent' },
    { ns: 'settings/thresholds', key: 'fields.compression.background_follow_up_text_limit' },
    ...
    { ns: 'settings/thresholds', key: 'fields.tool_timeout.browser_max_wait_ms' },
    ...
    { ns: 'settings/thresholds', key: 'fields.memories.stage_one_max_tokens' },
    ...
    { ns: 'settings/thresholds', key: 'fields.insights.max_transcript_chars' },
    { ns: 'settings/thresholds', key: 'fields.file_read.max_total_chars' },
    { ns: 'settings/thresholds', key: 'fields.session_title.truncate_user_message_chars' },
    { ns: 'settings/thresholds', key: 'fields.persistence.session_reference_transcript_char_limit' },
    { ns: 'settings/thresholds', key: 'fields.user_questions.header_max_chars' },
    { ns: 'settings/thresholds', key: 'fields.session_control.short_name_max_chars' },
  ],
