...
const ReviewTeamPage: React.FC = () => {
  ...
  return (
    <ConfigPageLayout className="review-team-page" data-bf-component="review-team-page" data-bf-part="root">
      <ConfigPageHeader
      ...
      <ConfigPageContent>
        ...
        >
          <button
            ...
            data-bf-component="review-team-page"
            data-bf-part="policy"
        ...
        >
          <div className="review-team-page__member-layout">
            <div className="review-team-page__member-list" data-bf-component="review-team-page" data-bf-part="memberList">
