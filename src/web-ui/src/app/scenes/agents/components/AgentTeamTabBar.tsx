...
const AgentTeamTabBar: React.FC = () => {
  ...
  return (
    <div className="bt-tabbar" data-bf-component="agent-team-tab-bar" data-bf-part="root">
      <div className="bt-tabbar__rail" data-bf-component="agent-team-tab-bar" data-bf-part="rail">
        {/* Tabs */}
        {agentTeams.map((team) => {
