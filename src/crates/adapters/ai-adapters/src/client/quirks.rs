...
pub(crate) fn anthropic_usage_semantics_for_url(
    url: &str,
) -> crate::stream::types::anthropic::AnthropicUsageSemantics {
    if is_zhipuai_url(url) || is_openbitfun_anthropic_url(url) {
