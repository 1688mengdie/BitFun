//! Session tree data model and traversal guards.
//!
//! This is the shared foundation for session-tree display and lineage
//! telemetry. Runtime-ports re-exports the authoritative constants.
