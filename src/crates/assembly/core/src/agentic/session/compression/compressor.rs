...
impl ContextCompressor {
    ...
    pub fn plan_compression(
        ...
        self.plan_compression_for_turn_internal(
            session_id,
            None,
            runtime_messages,
            context_window,
    ...
    fn plan_compression_for_turn_internal(
        &self,
        session_id: &str,
        ...
        debug!(
            "Compression plan: session_id={}, current_turn_id={:?}, retained_user_token_budget={}, retained_user_tokens={}, retained_user_messages={}, recent_target_tokens={}, recent_tail_tokens={}, cutoff_message_index={}, summary_messages={}, recent_tail_messages={}, next_recent_target_tokens={:?}",
            session_id,
            current_turn_id,
