...
pub use framework::{
    ...
    classify_tool_call, collect_loaded_deferred_tool_specs, get_tool_spec_input_schema,
    ...
    subagent_tool_restrictions, summarize_get_tool_spec_deferred_tools, tool_manifest_sort_rank,
    ...
    LoadedDeferredToolSpec, OperationClass, ParsedBitFunCurrentSessionUri, ParsedBitFunRuntimeUri,
    ...
    ToolRuntimeRestrictionsPatch, ToolWorkspaceKind, ValidationResult,
